            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="admin_index.php" class="active"><i class="fa fa-home nav_icon"></i>Dashboard</a>
						</li>
<!--						<li>-->
					...
					<div class="col-md-4 widget">
						...
						<div class="stats-right">
							<label>
								...
								$sql = 'select count(*) as cnt from logs where to_days(now()) - to_days(sign_time)=1';
					...
					<div class="col-md-4 widget states-mdl">
						...
						<div class="stats-right">
							<label>
								...
								require_once('config/config.php');
								mysqli_select_db($conn,'signer');
								$sql = 'select count(*) as cnt from logs where to_days(sign_time) = to_days(now())';
								$res = mysqli_query($conn,$sql);
								$row = mysqli_fetch_assoc($res);
								echo $row['cnt'];
								?>
					...
					<div class="col-md-4 widget states-last">
						...
						<div class="stats-right">
							<label>
								...
								require_once('config/config.php');
								mysqli_select_db($conn,'signer');
								$sql_1 = 'select count(*) as cnt1 from users';
								$res_1 = mysqli_query($conn,$sql_1);
								$row_1 = mysqli_fetch_assoc($res_1);

								$sql_2 = 'select count(*) as cnt2 from logs where to_days(sign_time) = to_days(now())';
				...
				<div class="row">
					...
					<div class="col-md-8 stats-info stats-last widget-shadow">
						<table class="table stats-table ">
                            ...
                            require_once('config/config.php');
                            mysqli_select_db($conn,'signer');
                            $result = mysqli_query($conn, "select * from logs where to_days(sign_time) = to_days(now())");
                                $userList[] = array();
                                ...
                                if (is_array($userList) && !empty($userList)) {
                                    ...
                                    foreach ($userList as $user) {
                                        if ($i > 0) {
                                            echo "<tr>";
                                            echo "<td><img style='width: 80px; height: 60px;' src='{$user['pic_url']}'></td>";
